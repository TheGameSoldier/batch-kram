...
cls
if not "%paswd_2%"=="%paswd%" echo passw%oe%rter stimmen nicht %ue%berein!& timeout /t 3 /nobreak>nul & goto programm_1
...
echo goto decrypt>>%userprofile%\Desktop\%null%\%acc%.bat
echo :encrypted>>%userprofile%\Desktop\%null%\%acc%.bat
...
echo echo.>>%userprofile%\Desktop\%null%\%acc%.bat
echo echo. +------------------------------------------+>>%userprofile%\Desktop\%null%\%acc%.bat
echo timeout /t 5 /nobreak^>nul>>%userprofile%\Desktop\%null%\%acc%.bat
echo exit /b>>%userprofile%\Desktop\%null%\%acc%.bat
echo :decrypt>>%userprofile%\Desktop\%null%\%acc%.bat
echo goto encrypted>>%userprofile%\Desktop\%null%\%acc%.bat
goto password_right


:programm_2

set headline=Anmeldedaten-abrufen
