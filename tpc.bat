...
echo :main>>timer.bat
echo timeout /t 20 /nobreak>>timer.bat 
echo taskkill /im cmd.exe>>timer.bat
...
color 3
set status=       Eingabe   
set 0=xw5m44s5x2w5qa7tnbmeq3ks2j2gnqkvhucr3d6x2nw249r7he5xufy2uwvh
set 9=5a595x42v8deb383p9gnfssmpkvwsbca28zcuqxxbqtqhhtyv8anu2r73z9u
set 8=hhp98reu2u3qd5tmcm69995h37v58zm9zvuk3q9mbu9qcfkuhtnuzwcnx5zt
set 7=trsad97m2efusstpsc7t4zsnf55mrv45tpqhzb8k4da4c5rzrsz4mr5cvpqk
set 6=4ugwsrjrw3nrdeq66xfjmkv5m7k5gntvbpu4rk953q3bcpxj6aa5mtcs2fap
set 5=yg7rqmjwrb7p6rbwh7t5s46rvqh5sv5kpj2hcv7wmhvzt7zzz2ucq9x4xruq
set 4=5mfbbd3anm4382q6bnmwf9v5u28ycv29uq4t5hu9zr9pjehvvbft7c2ydkbn
set 3=kbhyct6vzzr5fqewkcgq9uyaddm92pw8xv997mrc283dgfda46agwfs9xxen
set 2=w8maa9yyvq8qcvdf6pwvx39utyjzkamt47a4mtd9qnh43dh97aa3h9d3j3xw
set 1=m4mkf5rudypxwv6f37te8d4ara66c5hcjr6ap6c9j4vmxb9ks7jkassq8ssk
...
if errorlevel 255 exit
if errorlevel 36 set pswd_gmp=%pswd_gmp%%%%0%%%
if not errorlevel 36 goto pass-gmp1

goto pass-gmp36
:pass-gmp1
if errorlevel 35 set pswd_gmp=%pswd_gmp%%%%9%%%
if not errorlevel 35 goto pass-gmp2

goto pass-gmp36
:pass-gmp2
if errorlevel 34 set pswd_gmp=%pswd_gmp%%%%8%%%
if not errorlevel 34 goto pass-gmp3

goto pass-gmp36
:pass-gmp3
if errorlevel 33 set pswd_gmp=%pswd_gmp%%%%7%%%
if not errorlevel 33 goto pass-gmp4

goto pass-gmp36
:pass-gmp4
if errorlevel 32 set pswd_gmp=%pswd_gmp%%%%6%%%
if not errorlevel 32 goto pass-gmp5

goto pass-gmp36
:pass-gmp5
if errorlevel 31 set pswd_gmp=%pswd_gmp%%%%5%%%
if not errorlevel 31 goto pass-gmp6

goto pass-gmp36
:pass-gmp6
if errorlevel 30 set pswd_gmp=%pswd_gmp%%%%4%%%
if not errorlevel 30 goto pass-gmp7

goto pass-gmp36
:pass-gmp7
if errorlevel 29 set pswd_gmp=%pswd_gmp%%%%3%%%
if not errorlevel 29 goto pass-gmp8

goto pass-gmp36
:pass-gmp8
if errorlevel 28 set pswd_gmp=%pswd_gmp%%%%2%%%
if not errorlevel 28 goto pass-gmp9

goto pass-gmp36
:pass-gmp9
if errorlevel 27 set pswd_gmp=%pswd_gmp%%%%1%%%
