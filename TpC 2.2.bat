...
echo. ^| Beispiel:^|      ^|                               ^|^|                  ^|                              ^|
echo. ^+----------+      ^|                               ^|^|                  ^|                              ^|
echo. ^| Internetseite:  ^|    Beispielseite              ^|^| Internetseite:   ^|   %acc%%leer_acc%^|
...
set leer_acc=
set leer_acc_number=27
call :col_txt ff "aaa"
set/p ask_leer_acc=Wie viele stellen hat der Name der Internetseite? (Maximal 26) 
